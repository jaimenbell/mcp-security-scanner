...
**Done (this repo):** four grounded detectors, AST-based Python analysis, honest confidence/severity model, client-facing markdown + JSON reports, CI gate, and a passing dogfood self-audit against six real servers.
